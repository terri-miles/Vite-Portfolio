...
function NavBar() {
  ...
  return (
    <>
      <div id="Home" className={`py-6 mx-auto sticky top-0 z-20 ${isTopOfPage ? "" : "bg-black/80 drop-shadow-md"}`}>
        <div className="flex justify-between items-center relative">
          <div className="text-[20px] font-bold sm:mx-[16px] md:mx-[24px]">
          ...
          <div
            ...
            className={`sm:block sm:mx-[16px] md:hidden cursor-pointer ${
              openMenu ? "toggle" : ""
            }`}
          >
        ...
        <div
          className={`md:hidden absolute right-0 top-[75px] bg-black/90 w-[100%] h-[500px] pt-[50px] transform duration-200 origin-top z-10 ${
            openMenu ? "sm:scale-y-1" : "sm:scale-y-0"
          }`}
        >
